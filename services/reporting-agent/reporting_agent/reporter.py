...
def _render_html(
    *,
    ...
    fixture_banner = (
        ...
        "⚠ This executive summary was generated from a fixture, not a live analysis, "
        "because no AI credential was configured. Regenerate this report before filing "
        "or relying on it."
        "</div>"
        if used_fixture
        else ""
...
def _fixture_gemini_data(stats: dict) -> dict:
    ...
    return {
        ...
        "executive_summary": summary + " [FIXTURE — no AI credential configured]",
    }
